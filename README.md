...
You can then execute your native executable with: `./target/renarde_bug_8-1.0-SNAPSHOT-runner`
...
- OpenTelemetry exporter: OTLP ([guide](https://quarkus.io/guides/opentelemetry)): Enable OTLP Exporter for
  OpenTelemetry
